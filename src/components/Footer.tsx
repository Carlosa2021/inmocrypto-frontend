...
export function Footer() {
  return (
    <footer className="w-full mt-20 bg-gradient-to-r from-indigo-950 via-blue-900 to-fuchsia-900 dark:from-zinc-900 dark:via-zinc-950 dark:to-zinc-900 text-white dark:text-zinc-300 py-10 px-6">
